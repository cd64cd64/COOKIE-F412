#define MICROPY_HW_BOARD_NAME       "Cookie Board" 
#define MICROPY_HW_MCU_NAME         "STM32F412Rx"

/* 启用 THREAD */ 
#define MICROPY_PY_THREAD           (1)

#define MICROPY_BOARD_EARLY_INIT    Cookie_board_early_init
void Cookie_board_early_init(void);
...
// LEDs
#define MICROPY_HW_LED1             (pin_B0) // Blue C13 LED on board
...
#define MICROPY_HW_SPIFLASH_CS      (pin_B2)
...
#define MICROPY_HW_FLASH_FS_LABEL "COOKIE"
